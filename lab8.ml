...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let curr_evt = !evt in
    let newid = new_id () in
    evt := {id = newid; action = listener} :: curr_evt;
    newid;;
...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    let curr_evt = !evt in
    let remove_id = List.filter (fun x -> x.id <> i) curr_evt in
    evt := remove_id;;
...
......................................................................*)
  ...
  let fire_event (evt : 'a event) (arg : 'a) : unit =
    let curr_evt = !evt in
    let _ = List.map (fun x -> x.action arg) curr_evt in
    ();;
...
let receive_report (s : string) =
   let bf = fun () -> (buzzFake s) in
   let fn = fun () -> (fakeNewsNetwork s) in
   let _ = add_listener publish bf in
   let _ = add_listener publish fn in
   ();;
